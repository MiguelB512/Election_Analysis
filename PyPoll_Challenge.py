...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_dict:
        ...
        county_results = (f"{county_name}: {county_percent:.1f}% ({county_votes:,})\n")
        ...
        if (county_votes > winning_number):
            winning_county = county_name
            winning_number = county_votes

    # 7: Print the county with the largest turnout to the terminal.
    largest_turnout = (
                      f"\n-------------------------\n"
                      f"Largest County Turnount: {winning_county} ({winning_number:,.1f})\n"
                      f"-------------------------\n")
